...
const siteConfig = {
  ...
  url: 'https://pbahner.github.io', // Your website URL
  baseUrl: '/longclaw/', // Base URL for your project */
  // For github.io type URLs, you would set the url and baseUrl like:
  //   url: 'https://facebook.github.io',
  //   baseUrl: '/test-site/',

  // Used for publishing and more
  projectName: 'longclaw',
  organizationName: 'PBahner',
  ...
  headerLinks: [
    {doc: 'tutorial/introduction', label: 'Docs'},
    {href: 'http://.google.com', label: 'Demo'},
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} James Ramm`,
  ...
  repoUrl: 'https://github.com/PBahner/longclaw',
};
